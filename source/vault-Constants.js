...
const VOID_IDENT = new Alias(VOID_FOUNDER_ALIAS, VOID_ANCESTOR_ALIAS, VOID_FATHER_ALIAS);
...
const LIMB_IDENT = new Alias(LIMB_FOUNDER_ALIAS, LIMB_ANCESTOR_ALIAS, LIMB_FATHER_ALIAS);
...
const CELESTIA_IDENT = new Alias(CELESTIA_FOUNER_ALIAS, CELESTIA_ANCESTOR_ALIAS, CELESTIA_FATHER_ALIAS);
